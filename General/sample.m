...
addpath('I:\My_Research\code\General');
load('I:\My_Research\data\Recon3D_301\Recon3DModel_301.mat');
load('I:\My_Research\data\Recon3D_301\equation.mat');%病毒的生物量合成反应
Recon3DModel_inf = addReaction( Recon3DModel,'biomass_virus',cell2mat(equation));

covid_path = 'I:\My_Research\data\covid\result\';
dirs = dir(covid_path);
%读取所有样本目录
file_list={};
for i=1:size(dirs,1)
...
rmpath('I:\My_Research\code\General');